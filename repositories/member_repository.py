...
def select_all():
    ...
    for result in results:
        member = Member[result["first_name"],result["last_name"],result["date_of_birth"],result["gender"],result["contact_info_email"],result["contact_info_number"],result["membership_type"],result["id"]]
